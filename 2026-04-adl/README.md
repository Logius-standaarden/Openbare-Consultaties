...
In het kader van het beheer en de doorontwikkeling van [Authorization Decision Log](https://logius-standaarden.github.io/authorization-decision-log/) houdt Logius een openbare consultatie.
...
## In het kort
Authorization Decision Log (Logboek Toegangsbeslissingen) is een standaard voor het vastleggen van genomen toegangsbeslissingen. Het logboek ondersteunt verantwoording binnen en tussen (semi-)overheidsorganisaties. Met deze consultatie vragen wij uw feedback op de eerste versie van het document.
...
Dit is de eerste versie van het document. Daarom is alle feedback welkom.

 
# Relevante documenten
Bekijk de documenten die bij deze consultatie horen:

- conceptversie Authorisation Decision Log;
- consultatieversie Authorization Decision Log;
- notulen van de Werkgroep FTV (Federatieve Toegangsverlening);
- GitHub-repository.

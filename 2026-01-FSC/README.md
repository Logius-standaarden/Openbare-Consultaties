...
- FSC Core
- Refinement Service properties
- Introductie van Distribute-Only-Peer
- FSC External Contract Reference extension
- Eerste opzet extensie (dit moet beter verwoord worden)
- FSC test suite

## Reageren?

Reageren kan door middel van een issue op wijzigingsvoorstel op de [repository]()
